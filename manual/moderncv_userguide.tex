...
\begin{itemize}
 \item By redefining the internal commands \code{\\labelitemi} and \code{\\labelitemii} as well as\\
...
In case you want to add a subject to you letter of motivation, add the following in the preamble
\begin{lstlisting}
